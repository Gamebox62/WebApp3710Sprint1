...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference("Stat.count") do
      post stats_url, params: { stat: { admin_id: @stat.admin_id, description: @stat.description, solution: @stat.solution, title: @stat.title } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { admin_id: @stat.admin_id, description: @stat.description, solution: @stat.solution, title: @stat.title } }

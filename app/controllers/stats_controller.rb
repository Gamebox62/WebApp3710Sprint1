class StatsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to stats_path, status: :see_other, notice: "Stat was successfully destroyed." }
  ...
  private
    ...
    def stat_params
      params.require(:stat).permit(:title, :solution, :description, :admin_id)
    end
end
